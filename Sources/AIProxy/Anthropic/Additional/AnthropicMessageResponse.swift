...
extension AnthropicMessageResponse {
...
// MARK: AnthropicMessageResponse.Content + DynamicContent

public extension AnthropicMessageResponse.Content.DynamicContent {
  ...
  var arrayValue: [AnthropicMessageResponse.Content.DynamicContent]? {
  ...
  var dictionaryValue: [String: AnthropicMessageResponse.Content.DynamicContent]? {
...
// MARK: AnthropicMessageResponse.Content + TextEditorCommand

public extension AnthropicMessageResponse.Content {
...
// MARK: AnthropicMessageResponse.Content + ToolResultContent
