//
//  AnthropicMessageStreamResponse.swift
//  AIProxy
//
...
public struct AnthropicMessageStreamResponse: Decodable, @unchecked Sendable {
   ...
   public struct Delta: Decodable {
      ...
      public let citation: AnthropicMessageResponse.Citation?
   ...
   public struct ContentBlock: Decodable {
      ...
      public let citations: [AnthropicMessageResponse.Citation]?
      
      /// `tool_use` and `server_tool_use` type
      public let input: [String: AnthropicMessageResponse.Content.DynamicContent]?
      
      public let name: String?
      
      public let id: String?
      
      public var toolUse: AnthropicMessageResponse.Content.ToolUse? {
...
extension AnthropicMessageStreamResponse {
